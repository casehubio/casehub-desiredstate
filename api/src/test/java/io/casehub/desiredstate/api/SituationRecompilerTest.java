...
class SituationRecompilerTest {
    ...
    void situationRecompiler_canBeImplemented() {
        SituationRecompiler recompiler = (tid, current, actual, situation, factory) -> Optional.empty();
        ...
        Optional<CompilationResult> result = recompiler.recompile("tenant-1", null, new ActualState(Map.of()), situation, mockFactory);
    ...
    void situationRecompiler_canReturnNewGraph() {
        ...
        SituationRecompiler recompiler = (tid, current, actual, situation, factory) -> Optional.of(CompilationResult.single(mockGraph));
        ...
        Optional<CompilationResult> result = recompiler.recompile("tenant-1", null, new ActualState(Map.of()), situation, null);
