...
class PersistentDriftGanglionTest {

    private final PersistentDriftGanglion ganglion = new PersistentDriftGanglion();
    ...
    @Test
    void driftEvent_returnsDetected() {
        CloudEvent event = buildEvent(DesiredStateEventTypes.NODE_DRIFTED, "unit-1");
